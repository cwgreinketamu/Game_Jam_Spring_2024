...
public class BugMoving : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        randX = Random.Range(1.0f, 2.0f) * modifier[Random.Range(0, 2)]; //randX: [-2,-1]U[1,2]
        randY = Random.Range(1.0f, 2.0f) * modifier[Random.Range(0, 2)]; //randY: [-2,-1]U[1,2]
    }

    // Update is called once per frame
    void FixedUpdate()
    {
        transform.position += new Vector3(randX*speed, randY*speed);
